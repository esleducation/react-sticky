...
var Sticky = React.createClass({
  ...
  statics: {
    ...
    /*
     * Light copy object utility method
     */
    copyStyles: function(dest, source) {
  ...
  pageOffset: function() {
    ...
    for (var i = 0; i < otherStickies.length; i++) {
      ...
      if (otherSticky.state.isSticky) {
        otherStickyOffsets += otherSticky.domNode.getBoundingClientRect().height - otherSticky.props.topOffset;
      }
    }
  ...
  nextStyle: function(shouldBeSticky) {
    if (shouldBeSticky) {
      ...
      if(this.props.translate) {
        var pos = this.pageOffset() - this.props.topOffset - this.origin;
        return Sticky.copyStyles(Sticky.copyStyles({
          transform: 'translateY('+pos+'px)'
        }, this.props.translateStyle), this.props.style);
      } else {
        return Sticky.copyStyles(Sticky.copyStyles({}, this.props.style), this.props.stickyStyle);
      }
    } else {
